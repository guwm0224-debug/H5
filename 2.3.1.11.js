...
(function () {
    ...
    class VideoSpeedController {
        ...
        _runDiagnostics() {
            ...
            const registeredModules = runStep('模块状态扫描', () => this.moduleRegistry.list());
            ...
            const summary = [
                ...
                `控制面板: ${diagnostics.panelExists ? '已创建' : '缺失'}`,
                `UI状态: ${JSON.stringify(diagnostics.uiState || {})}`,
                `模块: ${diagnostics.registeredModules.length ? diagnostics.registeredModules.join(', ') : '无'}`,
